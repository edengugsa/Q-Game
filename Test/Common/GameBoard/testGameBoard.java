...
//        g.placeTile(new Coordinate(0,1), new Tile(Color.BLUE, QShape.CIRCLE));
//        g.placeTile(new Coordinate(1,1), new Tile(Color.BLUE, QShape.DIAMOND));
//        g.placeTile(new Coordinate(2,1), new Tile(Color.orange, QShape.DIAMOND));
//        g.placeTile(new Coordinate(2,0), new Tile(Color.orange, QShape.EIGHT_STAR));
//    }
//
//    @Test
...
//        expected.add(new Coordinate(1, 0));
//        expected.add(new Coordinate(0,-1));
//        ArrayList<Coordinate> actual = g.getOptions(new Tile(Color.RED, QShape.SQUARE));
//        assertEquals(actual.size(), 4);
//        assertEquals(expected, actual);
//        placeTiles();
//        g.placeTile(new Coordinate(-1,1), new Tile(Color.BLUE, QShape.CIRCLE));
//        assertEquals(g.getOptions(new Tile(Color.BLUE, QShape.STAR)).size(), 4);
//    }
//
//    @Test
//    public void NoOptionsTest() {
//        GameBoard g = new GameBoard(new Tile(Color.RED, QShape.CIRCLE));
